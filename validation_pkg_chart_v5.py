...
ax.text(COL_BOUND_X, current_y, "境界", fontweight="bold", fontsize=11, ha="center", va="center")
...
bottom_reserved_space = (ref_rows * 3.5) + 30.0
...
for i, row in mart.iterrows():
    ...
    ax.text(COL_BOUND_X, current_y, row["boundary"], fontsize=9.5, ha="center", va="center",
            bbox=dict(boxstyle="round,pad=0.25", facecolor="white", edgecolor="gray"), zorder=2)
...
ax.text(qr_x_center, qr_y_center - qr_size/2 - 1.5, "判定アプリ\n(GEMINI Pro 3.1 試作)", 
...
print("==========================================")
print("v5 最終印刷用（レイアウト微調整版） 早見表生成完了")
